...
const PROVIDERS: Readonly<Record<string, ProviderSpec>> = {
  ...
  meta: { envKeys: ["META_API_KEY"] },
  "meta-chat": { envKeys: ["META_API_KEY"] },
  "meta-anthropic": { envKeys: ["META_API_KEY"] },
  moonshotai: { envKeys: ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"] },
  "moonshotai-responses": { envKeys: ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"] },
  "moonshotai-anthropic": { envKeys: ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"] },
